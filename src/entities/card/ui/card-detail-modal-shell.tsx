...
export default function CardDetailModalShell({
  ...
  return (
    ...
    >
      <DialogContent className="flex max-h-[90dvh] w-[94vw] max-w-[960px] flex-col overflow-hidden rounded-lg border-[#dedbd3] bg-[#f9f8f4] p-0 text-[#292724] shadow-lg dark:border-[#3a3834] dark:bg-[#242320] dark:text-[#ebe7df]">
