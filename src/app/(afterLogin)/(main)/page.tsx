...
import { BrainCircuit, Link as LinkIcon, Target, Lightbulb, PenTool } from "lucide-react";
        ...
        <section className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-12 px-4 pb-16 pt-20 md:flex-row md:pt-32 md:pb-24 sm:px-6 lg:px-8">
          <div className="z-10 flex flex-1 flex-col gap-6 text-center md:text-left">
            ...
            <p className="mx-auto max-w-2xl text-lg font-normal leading-relaxed text-muted-foreground md:mx-0 md:text-xl break-keep">
              밑줄 친 문장들을 연결해 나만의 지식 지도를 만들어보세요. 리딩덱이 파편화된 영감을 자산으로 바꿔줍니다.
            </p>
            <div className="flex flex-col justify-center gap-4 pt-4 sm:flex-row md:justify-start">
              <Button size="lg" as={Link} href="/login" className="text-base font-bold px-8 py-6 rounded-full shadow-lg hover:-translate-y-1 transition-transform">
                  구글로 3초 만에 시작하기
          ...
          <div className="relative flex h-[400px] w-full flex-1 items-center justify-center md:h-[500px]">
            ...
            <div className="relative w-full max-w-md h-full flex items-center justify-center">
              ...
              <div className="absolute top-10 left-10 p-3 bg-card border border-border rounded-lg shadow-sm w-32 transform -rotate-6 transition-transform hover:scale-105">
                <span className="text-xs font-semibold text-sky-500">Action</span>
                <p className="text-xs text-muted-foreground mt-1 line-clamp-2">실행 가능한 아이디어</p>
              </div>
              <div className="absolute bottom-10 right-10 p-3 bg-card border border-border rounded-lg shadow-sm w-32 transform rotate-6 transition-transform hover:scale-105">
                <span className="text-xs font-semibold text-emerald-500">Insight</span>
                <p className="text-xs text-muted-foreground mt-1 line-clamp-2">새로운 관점의 발견</p>
              </div>
              <div className="absolute top-1/2 -right-10 p-3 bg-card border border-border rounded-lg shadow-sm w-32 transform -rotate-3 -translate-y-1/2 transition-transform hover:scale-105">
                <span className="text-xs font-semibold text-amber-500">Quote</span>
                <p className="text-xs text-muted-foreground mt-1 line-clamp-2">인상 깊은 문구</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto w-full max-w-[1200px] px-4 py-20 md:py-32 sm:px-6 lg:px-8 space-y-32">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              <Badge variant="outline" className="px-3 py-1 text-sm border-primary/50 text-primary bg-primary/5">Step 1. 인사이트 추출</Badge>
              <h2 className="text-3xl md:text-4xl font-bold leading-tight break-keep">
                책 속의 문장, 눈으로만 읽지 말고 <br className="hidden md:block"/> 카드로 기록하세요.
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed break-keep">
                완독에 대한 부담을 버리세요. 나에게 울림을 준 단 하나의 문장과 생각만이라도 '생각 카드'로 남겨두면, 그것이 곧 당신의 자산이 됩니다.
              </p>
            </div>
                ...
                <Card className="shadow-xl border-border bg-card transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl">
                  <div className="relative flex h-28 flex-col rounded-t-xl bg-muted px-4 pb-4 pt-8">
                    ...
                    <div className="flex flex-1 flex-col justify-end text-left">
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">제임스 클리어</p>
                    </div>
                  </div>
                  <div className="flex flex-1 flex-col justify-between gap-4 p-6">
                    <p className="text-sm leading-relaxed text-foreground/90">
                      "우리는 목표의 수준까지 높아지는 것이 아니라, 시스템의 수준까지 떨어진다."
                      <br/><br/>
                      목표보다는 매일의 시스템과 루틴에 집중해야겠다.
                    </p>
                    <div className="mt-4 flex items-center justify-between border-t border-border/50 pt-4">
                      <span className="text-[10px] text-muted-foreground">방금 전 저장됨</span>
                    </div>
                  </div>
                </Card>
              </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="flex-1 space-y-6">
              <Badge variant="outline" className="px-3 py-1 text-sm border-primary/50 text-primary bg-primary/5">Step 2. 지식의 연결</Badge>
              <h2 className="text-3xl md:text-4xl font-bold leading-tight break-keep">
                파편화된 생각들을 연결해 <br className="hidden md:block"/> 나만의 지식 지도를 완성하세요.
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed break-keep">
                리딩덱의 강력한 화이트보드 캔버스에서 개별 카드들을 노드 형태로 연결하세요. 책의 경계를 넘어 생각과 생각을 이어 하나의 거대한 인사이트 덱을 구성할 수 있습니다.
              </p>
            </div>
              ...
              <div className="relative w-full h-full max-w-[400px] aspect-square">
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-bold text-muted-foreground">습관의 시스템</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-bold text-foreground">넛지(Nudge) 설계</span>
                  </div>
                  <p className="text-xs text-muted-foreground">좋은 습관을 만들기 위한 선택 설계의 중요성</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-bold text-muted-foreground">선택의 심리학</span>
                  </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              <Badge variant="outline" className="px-3 py-1 text-sm border-primary/50 text-primary bg-primary/5">Step 3. 리마인드와 복습</Badge>
              <h2 className="text-3xl md:text-4xl font-bold leading-tight break-keep">
                잊혀지던 영감을 매일 다시 마주하며 <br className="hidden md:block"/> 확실한 내 것으로.
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed break-keep">
                매일 제공되는 나만의 카드 스택을 통해 과거에 읽었던 책의 인사이트를 복습하세요. 잊고 있던 문장들이 새로운 아이디어를 위한 불씨가 되어줍니다.
              </p>
            </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex gap-2">
                      <div className="w-8 h-8 rounded-full border border-border bg-background flex items-center justify-center text-xs text-muted-foreground shadow-sm">←</div>
                      <div className="w-8 h-8 rounded-full border border-border bg-background flex items-center justify-center text-xs text-foreground shadow-sm">→</div>
                    </div>
                  </div>
                  <div className="flex gap-4 overflow-hidden py-2">
                    {[
                      { type: "QUOTE", color: "text-amber-500", bg: "bg-amber-500", text: "상상력은 결핍에서 나온다." },
                      { type: "ACTION", color: "text-sky-500", bg: "bg-sky-500", text: "내일 아침 첫 1시간은 글쓰기에 투자하기." },
                    ].map((item, i) => (
                      <div key={i} className="min-w-[240px] h-36 bg-background rounded-xl border border-border p-5 flex flex-col shadow-sm transition-transform hover:-translate-y-1 cursor-pointer">
                        <div className="flex items-center gap-2 mb-3">
                          <div className={`w-1.5 h-1.5 rounded-full ${item.bg}`}></div>
                          <span className={`text-[10px] font-bold ${item.color}`}>{item.type}</span>
                        </div>
                    ...
                    <div className="min-w-[240px] h-36 bg-background rounded-xl border border-border p-5 flex flex-col shadow-sm opacity-50">
                       <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-[10px] font-bold text-emerald-500">INSIGHT</span>
                        </div>
        ...
        <section className="border-y border-border bg-muted/30 py-24">
          <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">이런 분들께 리딩덱을 추천합니다</h2>
            </div>
              ...
              <Card className="bg-card/50 hover:bg-card hover:shadow-lg transition-all duration-300 border-transparent hover:border-border">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed break-keep">
                    여기저기 흩어진 레퍼런스와 아티클의 핵심 내용만 발췌하여, 하나의 프로덕트 철학 덱으로 구조화해보세요.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-card/50 hover:bg-card hover:shadow-lg transition-all duration-300 border-transparent hover:border-border">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed break-keep">
                    쏟아지는 트렌드 리포트와 영감을 주는 카피들을 카드 형태로 아카이빙하고, 캠페인 기획 시 빠르게 꺼내어 활용하세요.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-card/50 hover:bg-card hover:shadow-lg transition-all duration-300 border-transparent hover:border-border">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed break-keep">
                    독서 노트와 논문 요약본을 지식 지도로 연결하여, 글쓰기나 과제 작성 시 끊임없이 솟아나는 영감의 원천으로 만드세요.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                다른 사람들이 완성한 지식 지도를 템플릿처럼 활용해 영감을 얻어보세요.
              </p>
            </div>
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex flex-wrap gap-2">
                      {deck.tags.map(tag => (
                        <span key={tag} className="text-[10px] font-medium px-2 py-1 bg-muted rounded-md text-muted-foreground">{tag}</span>
                      ))}
                    </div>
                    <span className="text-[10px] font-bold text-primary bg-primary/10 px-2 py-1 rounded-md">{deck.cards}</span>
                  </div>
                  <h3 className="text-lg font-bold mb-6 group-hover:text-primary transition-colors leading-snug">{deck.title}</h3>
                  <div className="flex items-center gap-2 pt-4 border-t border-border/50">
                    <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-[10px] font-bold text-primary">
                      {deck.author[0]}
                    </div>
                    <span className="text-xs text-muted-foreground">{deck.author}</span>
                  </div>
                </Card>
              ))}
            </div>
          ...
          <div className="relative mx-auto max-w-4xl overflow-hidden rounded-[2.5rem] bg-primary p-12 text-center shadow-2xl shadow-primary/20 md:p-24">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <h2 className="mb-6 text-3xl font-black text-white md:text-5xl leading-tight break-keep">
                지금 바로 나만의 지식 서재를 <br className="hidden md:block" /> 만들어보세요.
              </h2>
              <p className="mb-10 max-w-xl text-lg text-primary-foreground/90 break-keep">
                완독의 강박에서 벗어나, 나를 변화시키는 문장들에 집중할 시간입니다.
              </p>
              <Button
                as={Link}
                href="/login"
          ...
          <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold tracking-tight">ReadingDeck</span>
              </div>
              <div className="flex flex-wrap gap-6 text-sm text-muted-foreground">
                ...
                <a href="mailto:support@readingdeck.com" className="hover:text-foreground transition-colors">문의하기</a>
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-start justify-between border-t border-border/50 pt-8 gap-4">
              <div className="text-xs text-muted-foreground space-y-2">
                <p>상호명: ReadingDeck | 대표: 홍길동 | 이메일: support@readingdeck.com</p>
